...
```javascript
dwapx = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dwapx@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dwapx = require( 'path/to/vendor/umd/blas-ext-base-dwapx/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-dwapx@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-dwapx.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-dwapx

[test-image]: https://github.com/stdlib-js/blas-ext-base-dwapx/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/blas-ext-base-dwapx/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-dwapx/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-dwapx?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-dwapx.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-dwapx/main
...
[deno-url]: https://github.com/stdlib-js/blas-ext-base-dwapx/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-dwapx/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-dwapx/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-dwapx/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-dwapx/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-dwapx/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-dwapx/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-dwapx/main/LICENSE
